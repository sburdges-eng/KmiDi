...
ChordDisplay::ChordDisplay() { setOpaque(false); }

void ChordDisplay::setChord(const juce::String &chordName,
...
void ChordDisplay::drawChordName(juce::Graphics &g,
  ...
  g.drawText(chordName_, mutableBounds.removeFromTop(30),
             juce::Justification::centred);
}

void ChordDisplay::drawChordNotes(juce::Graphics &g,
                                  const juce::Rectangle<int> &bounds) {
  if (chordNotes_.empty())
    return;
...
void ChordDisplay::resized() { repaint(); }
