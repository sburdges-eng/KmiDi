...
CassetteView::~CassetteView() { stopTimer(); }
...
void CassetteView::drawCassetteBody(juce::Graphics &g,
                                    const juce::Rectangle<int> &bounds) {
  // Main cassette body with gradient
  juce::ColourGradient gradient(KellyLookAndFeel::surfaceColor.brighter(0.1f),
...
void CassetteView::drawTapeReels(juce::Graphics &g,
                                 const juce::Rectangle<int> &bounds) {
  int reelSize = 35;
  ...
  // Left reel
  auto leftReel = juce::Rectangle<int>(
      leftHoleX - reelSize / 2, holeY - reelSize / 2, reelSize, reelSize);
  ...
  auto rightReel = juce::Rectangle<int>(
      rightHoleX - reelSize / 2, holeY - reelSize / 2, reelSize, reelSize);
  g.setColour(juce::Colours::darkgrey);
...
void CassetteView::drawTapeWindow(juce::Graphics &g,
                                  const juce::Rectangle<int> &bounds) {
...
void CassetteView::drawLabel(juce::Graphics &g,
                             const juce::Rectangle<int> &bounds) {
  // Draw label area
