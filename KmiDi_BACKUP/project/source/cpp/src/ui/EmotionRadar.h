...
private:
  ...
  void drawPoint(juce::Graphics &g, float valence, float arousal,
                 float intensity, juce::Colour colour, bool isTarget = false);
  juce::Point<float> emotionToPoint(float valence, float arousal,
                                    float intensity,
