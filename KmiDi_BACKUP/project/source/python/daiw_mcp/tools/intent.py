            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "core_event": {"type": "string", "description": "Phase 0: What happened?"},
                        "core_longing": {
                            "type": "string",
            ...
            if name == "create_intent":
                ...
                intent = CompleteSongIntent(
                    ...
                    song_root=SongRoot(
                        ...
                        core_transformation=arguments.get(
                ...
                if not Path(intent_file).exists():
                    return [
                        TextContent(
                            type="text", text=f"Error: Intent file not found: {intent_file}"
                        )
                    ]
                ...
                if "output_midi" in arguments:
                    ...
                    tempo = getattr(
                        intent.technical_constraints, "technical_tempo_range", (82, 82)
                    )[0]
                ...
                result = {"intent_file": intent_file, "valid": len(issues) == 0, "issues": issues}
                return [TextContent(type="text", text=json.dumps(result, indent=2))]
