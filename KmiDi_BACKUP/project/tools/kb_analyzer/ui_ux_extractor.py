...
class UIUXExtractor:
    ...
    def extract_ui_ux(self, files: List[Path], repo_dir: Path, pipeline_components: Dict) -> Dict:
    ...
    def _extract_react_components(
        self, content: str, file_path: Path, repo_dir: Path
    ) -> List[Dict]:
    ...
    def _extract_swiftui_components(
        self, content: str, file_path: Path, repo_dir: Path
    ) -> List[Dict]:
