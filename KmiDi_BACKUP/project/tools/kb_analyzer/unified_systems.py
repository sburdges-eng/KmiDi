...
class UnifiedSystemDetector:
    ...
    def detect_systems(self, files: List[Path], repo_dir: Path, categorized: Dict) -> List[Dict]:
    ...
    def _create_system(self, files: Set[Path], repo_dir: Path, categorized: Dict) -> Dict:
        ...
        system = {
            ...
            "components": [
                {"type": "file", "path": str(f.relative_to(repo_dir)), "absolute_path": str(f)}
                for f in files
            ],
