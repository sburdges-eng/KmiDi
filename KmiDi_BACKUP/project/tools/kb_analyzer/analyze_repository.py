...
def main():
    parser = argparse.ArgumentParser(description="Analyze repository and create knowledge base")
    ...
    parser.add_argument(
        "--repo-dir", type=str, default=default_repo, help="Repository directory to analyze"
    )
    parser.add_argument(
        "--output-dir", type=str, default=default_output, help="Output directory for knowledge base"
    )
    parser.add_argument(
        "--mode",
        type=str,
    ...
    parser.add_argument(
        "--include-ui-ux", action="store_true", default=default_ui_ux, help="Include UI/UX analysis"
    )
    parser.add_argument(
        "--topic",
        type=str,
    ...
    files = [
        f for f in all_files if f.is_file() and not any(part in ignore_patterns for part in f.parts)
    ]
