        ...
        return [
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "tempo": {"type": "integer", "description": "Tempo in BPM", "default": 82},
                    },
                },
            ),
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "key": {"type": "string", "description": "Optional key context"},
                    },
                    "required": ["progression"],
                },
            ),
            ...
            Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "progression": {"type": "string", "description": "Chord progression string"}
                    },
                    "required": ["progression"],
                },
            ),
            ...
            if name == "analyze_progression":
                ...
                if "intent_file" in arguments:
                    ...
                    if not intent_path.exists():
                        return [
                            TextContent(
                                type="text", text=f"Error: Intent file not found: {intent_path}"
                            )
                        ]
                ...
                confidence_val = (
                    0.8 if diagnosis.get("key") and diagnosis.get("key") != "Unknown" else 0.3
                )
                result = {
                    "progression": progression,
                    "key": diagnosis.get("key", "Unknown"),
...
def _optimize_voice_leading(
    ...
    for chord_str in chords:
        ...
        chord_notes.append({"chord": chord_str, "notes": sorted(notes), "root": root_midi})

    if len(chord_notes) < 2:
        return ([], {"score": 1.0, "issues": [], "improvements": [], "parallel_motion": []})
    ...
    if large_leaps > 0:
        ...
        improvements.append(
            f"Consider reducing {large_leaps} large voice leaps for smoother motion"
        )
        ...
        formatted_voicings.append(
            {
                ...
                "notes": voicing,
                "note_names": [
                    f"{['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B'][n % 12]}{n // 12 - 1}"
                    for n in voicing
                ],
            }
        )
