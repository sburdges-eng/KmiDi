...
Examples:
    ...
    parser.add_argument(
        "--sanitize", action="store_true", help="Sanitize dataset (check for silence/corruption)"
    )
    parser.add_argument(
        "--golden", action="store_true", help="Mark this dataset as the 'Golden' validation set"
    )
    parser.add_argument(
        "--pack", action="store_true", help="Pack dataset into LMDB for high-speed I/O"
    )
