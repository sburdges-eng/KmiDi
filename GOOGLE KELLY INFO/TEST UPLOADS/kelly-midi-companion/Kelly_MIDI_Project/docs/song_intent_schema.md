...
tags: [songwriting, intent, schema, interrogation, rule-breaking, kellymidicompanion]
...
## Kelly MIDI Companion CLI Usage

```bash
# Create new intent from template
kellymidicompanion intent new --save my_song.yaml

# Process intent to generate elements
kellymidicompanion intent process my_song.yaml

# Suggest rules to break based on emotion
kellymidicompanion intent suggest --emotion grief

# Validate intent for completeness
kellymidicompanion intent validate my_song.yaml
```

---

## Connection to Kelly MIDI Companion Modules

| Intent Field | Kelly MIDI Companion Module | Output |
|--------------|-------------|--------|
