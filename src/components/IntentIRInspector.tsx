...
export const IntentIRInspector: React.FC<IntentIRInspectorProps> = ({
  frame,
  onFrameUpdate,
}) => {
  const [currentFrame, setCurrentFrame] = useState<IntentFrame | null>(
    frame || null,
  );
      ...
      <div className="intent-ir-inspector-content">
          ...
          {isExpanded["meta"] && (
            <div className="intent-ir-section-content">
              <div className="intent-ir-field">
                ...
                <span className="intent-ir-field-value">
                  {currentFrame.meta.ir_version}
                </span>
              </div>
              <div className="intent-ir-field">
                <span className="intent-ir-field-name">intent_id:</span>
                <span className="intent-ir-field-value">
                  {currentFrame.meta.intent_id.toString(16)}
                </span>
              </div>
              <div className="intent-ir-field">
                <span className="intent-ir-field-name">session_id:</span>
                <span className="intent-ir-field-value">
                  {currentFrame.meta.session_id.toString(16)}
                </span>
              </div>
            </div>
          )}
        ...
        <div className="intent-ir-section">
          ...
          {isExpanded["constraints"] && (
            <div className="intent-ir-section-content">
              <div className="intent-ir-field">
                <span className="intent-ir-field-name">
                  allowed_engines_mask:
                </span>
                <span className="intent-ir-field-value">
                  0x{currentFrame.constraints.allowed_engines_mask.toString(16)}
                </span>
              </div>
              <div className="intent-ir-field">
                <span className="intent-ir-field-name">
                ...
                <span className="intent-ir-field-value">
                  0x
                  {currentFrame.constraints.forbidden_engines_mask.toString(16)}
                </span>
              </div>
              <div className="intent-ir-field">
                <span className="intent-ir-field-name">max_cpu_cost:</span>
                <span className="intent-ir-field-value">
                  {currentFrame.constraints.max_cpu_cost.toFixed(3)}
                </span>
              </div>
              <div className="intent-ir-field">
                <span className="intent-ir-field-name">max_event_rate:</span>
                <span className="intent-ir-field-value">
                  {currentFrame.constraints.max_event_rate === Infinity
                    ? "∞"
                    : currentFrame.constraints.max_event_rate.toFixed(3)}
                </span>
              </div>
            </div>
          )}
          ...
          {isExpanded["provenance"] && (
            <div className="intent-ir-section-content">
              <div className="intent-ir-field">
                ...
                <span
                  className="intent-ir-field-value"
              ...
              <div className="intent-ir-field">
                <span className="intent-ir-field-name">
                  user_override_weight:
                </span>
                <span className="intent-ir-field-value">
                  {currentFrame.provenance.user_override_weight.toFixed(3)}
                </span>
              </div>
            </div>
          )}
