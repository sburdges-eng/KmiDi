      ...
      {selectedBase && selectedIntensity && selectedSub && (
        <div className="emotion-wheel-selected animate-fadeIn">
          <div className="emotion-wheel-selected-content">
            <div className="emotion-wheel-selected-label">
              Selected Emotion:
            </div>
          ...
          <button onClick={resetSelection} className="emotion-wheel-clear-btn">
            Clear
          </button>
        </div>
      )}
