 ...
 * - Track management
 */
class WorkstationPanel : public juce::Component, public juce::Timer {
public:
  struct TrackInfo {
    std::string name;
...
private:
  ...
  // Track visualization
  void paintTrack(juce::Graphics &g, const TrackInfo &track, int index,
                  const juce::Rectangle<int> &bounds);
  void paintTrackHeader(juce::Graphics &g, const TrackInfo &track, int index,
                        const juce::Rectangle<int> &bounds);
  void paintTrackContent(juce::Graphics &g, const TrackInfo &track,
                         const juce::Rectangle<int> &bounds);
