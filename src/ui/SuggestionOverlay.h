 ...
 *
 * Purpose: Displays intelligent suggestions to the user as tooltips or in a
 * side panel overlay. Part of Phase 3 of the "All-Knowing Interactive Musical
 ...
 * Part of Phase 3 of the "All-Knowing Interactive Musical Customization
 * System".
 */
