...
MusicTheoryPanel::MusicTheoryPanel() {
  ...
  keyLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  keyLabel_.setColour(juce::Label::textColourId,
                      KellyLookAndFeel::textPrimary); // Brighter text
  ...
  keySelector_.setTooltip(
      "Musical key: Select the root note (C, D, E, F, G, A, B)");
  ...
  scaleLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  scaleLabel_.setColour(juce::Label::textColourId,
                        KellyLookAndFeel::textPrimary); // Brighter text
  ...
  scaleSelector_.setTooltip(
      "Scale type: Major, Minor, or other scales (Dorian, Phrygian, etc.)");
  ...
  modeSelector_.setTooltip("Musical mode: Ionian (major), Aeolian (minor), "
  ...
  timeSigLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  timeSigLabel_.setColour(juce::Label::textColourId,
                          KellyLookAndFeel::textPrimary); // Brighter text
  timeSigLabel_.setTooltip("Time signature: numerator/denominator (e.g., 4/4 = "
  ...
  tempoSlider_.setTextBoxStyle(juce::Slider::TextBoxAbove, false, 80,
                               24);             // Larger, above slider
  tempoSlider_.setNumDecimalPlacesToDisplay(0); // Integer value
  tempoSlider_.setColour(juce::Slider::textBoxTextColourId,
                         KellyLookAndFeel::textPrimary);
  tempoSlider_.setColour(juce::Slider::textBoxBackgroundColourId,
                         KellyLookAndFeel::surfaceColor);
  tempoSlider_.setColour(juce::Slider::textBoxOutlineColourId,
                         KellyLookAndFeel::borderColor);
  tempoSlider_.setTooltip("Tempo in beats per minute (BPM): 40-200. Lower = "
                          "slower, higher = faster");
  ...
  reverbLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  reverbLabel_.setColour(juce::Label::textColourId,
                         KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(reverbLabel_);

  reverbToggle_.setButtonText("On");
  reverbToggle_.setToggleState(false, juce::dontSendNotification);
  reverbToggle_.setTooltip(
      "Enable reverb effect: Adds spatial depth and room ambience");
  ...
  reverbSlider_.setTextBoxStyle(juce::Slider::TextBoxAbove, false, 70,
                                22); // Larger, above slider
  reverbSlider_.setNumDecimalPlacesToDisplay(2);
  reverbSlider_.setColour(juce::Slider::textBoxTextColourId,
                          KellyLookAndFeel::textPrimary);
  reverbSlider_.setColour(juce::Slider::textBoxBackgroundColourId,
                          KellyLookAndFeel::surfaceColor);
  reverbSlider_.setColour(juce::Slider::textBoxOutlineColourId,
                          KellyLookAndFeel::borderColor);
  ...
  delayLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  delayLabel_.setColour(juce::Label::textColourId,
                        KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(delayLabel_);

  delayToggle_.setButtonText("On");
  delayToggle_.setToggleState(false, juce::dontSendNotification);
  delayToggle_.setTooltip(
      "Enable delay effect: Creates echo and rhythmic repeats");
  ...
  delaySlider_.setTextBoxStyle(juce::Slider::TextBoxAbove, false, 70,
                               22); // Larger, above slider
  delaySlider_.setNumDecimalPlacesToDisplay(2);
  delaySlider_.setColour(juce::Slider::textBoxTextColourId,
                         KellyLookAndFeel::textPrimary);
  delaySlider_.setColour(juce::Slider::textBoxBackgroundColourId,
                         KellyLookAndFeel::surfaceColor);
  delaySlider_.setColour(juce::Slider::textBoxOutlineColourId,
                         KellyLookAndFeel::borderColor);
  ...
  chorusLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  chorusLabel_.setColour(juce::Label::textColourId,
                         KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(chorusLabel_);

  chorusToggle_.setButtonText("On");
  chorusToggle_.setToggleState(false, juce::dontSendNotification);
  chorusToggle_.setTooltip(
      "Enable chorus effect: Adds width and shimmer to the sound");
  ...
  chorusSlider_.setTextBoxStyle(juce::Slider::TextBoxAbove, false, 70,
                                22); // Larger, above slider
  chorusSlider_.setNumDecimalPlacesToDisplay(2);
  chorusSlider_.setColour(juce::Slider::textBoxTextColourId,
                          KellyLookAndFeel::textPrimary);
  chorusSlider_.setColour(juce::Slider::textBoxBackgroundColourId,
                          KellyLookAndFeel::surfaceColor);
  chorusSlider_.setColour(juce::Slider::textBoxOutlineColourId,
                          KellyLookAndFeel::borderColor);
  ...
  notationToggle_.setTooltip(
      "Show sheet music notation: Display musical notation for generated MIDI");
  ...
  notationStyleLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  notationStyleLabel_.setColour(juce::Label::textColourId,
                                KellyLookAndFeel::textPrimary); // Brighter text
  ...
  notationStyleSelector_.setTooltip("Notation style: Traditional (classical), "
                                    "Modern (contemporary), or Jazz notation");
  ...
  chordSymbolsToggle_.setTooltip(
      "Show chord symbols: Display chord names (C, Am, F, etc.) on notation");
  ...
  romanNumeralsToggle_.setTooltip(
      "Show Roman numerals: Display chord functions (I, IV, V, vi, etc.)");
  ...
  eqLabel_.setTooltip(
      "Equalizer: Adjust frequency response based on emotion or genre");
  addAndMakeVisible(eqLabel_);

  eqToggle_.setButtonText("Enable EQ");
  eqToggle_.setToggleState(false, juce::dontSendNotification);
  eqToggle_.setTooltip(
      "Enable EQ processing: Apply frequency shaping based on selected preset");
  ...
  eqPresetLabel_.setColour(juce::Label::textColourId,
                           KellyLookAndFeel::textPrimary);
  eqPresetLabel_.setTooltip(
      "EQ Preset: Choose emotion or genre-based EQ curve");
  ...
  eqPresetSelector_.setTooltip("Select EQ preset: Auto applies based on "
                               "current emotion, or choose manually");
  ...
  eqAutoApplyLabel_.setColour(juce::Label::textColourId,
                              KellyLookAndFeel::textSecondary);
  eqAutoApplyLabel_.setTooltip("Auto-apply EQ: Automatically update EQ preset "
                               "when emotion or genre changes");
  addAndMakeVisible(eqAutoApplyLabel_);

  eqAutoApplyToggle_.setButtonText("");
  eqAutoApplyToggle_.setToggleState(
      true, juce::dontSendNotification); // Default: enabled
...
void MusicTheoryPanel::initializeInstruments() {
  ...
  leadInstrumentLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  leadInstrumentLabel_.setColour(
      juce::Label::textColourId,
      KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(leadInstrumentLabel_);

  leadInstrumentSelector_.addItem("Acoustic Grand Piano",
                                  GM::ACOUSTIC_GRAND_PIANO + 1);
  ...
  leadInstrumentSelector_.addItem("Acoustic Guitar (Nylon)",
                                  GM::ACOUSTIC_GUITAR_NYLON + 1);
  leadInstrumentSelector_.addItem("Electric Guitar (Clean)",
                                  GM::ELECTRIC_GUITAR_CLEAN + 1);
  leadInstrumentSelector_.setSelectedId(GM::ACOUSTIC_GRAND_PIANO + 1);
  leadInstrumentSelector_.setTooltip(
      "Lead instrument: The main melodic instrument in your composition");
  ...
  leadTechniqueLabel_.setFont(
      juce::FontOptions(13.0f).withStyle("Medium")); // Larger, readable
  leadTechniqueLabel_.setColour(juce::Label::textColourId,
                                KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(leadTechniqueLabel_);

  leadTechniqueSelector_.setTooltip("Playing technique for lead instrument: "
                                    "Legato, Staccato, Pizzicato, etc.");
  leadTechniqueSelector_.onChange = [this] { notifySettingsChanged(); };
  addAndMakeVisible(leadTechniqueSelector_);

  // Harmony Instruments
  harmonyInstrumentLabel_.setText("Harmony Instrument",
                                  juce::dontSendNotification);
  harmonyInstrumentLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  harmonyInstrumentLabel_.setColour(
      juce::Label::textColourId,
      KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(harmonyInstrumentLabel_);

  harmonyInstrumentSelector_.addItem("String Ensemble 1",
                                     GM::STRING_ENSEMBLE_1 + 1);
  harmonyInstrumentSelector_.addItem("String Ensemble 2",
                                     GM::STRING_ENSEMBLE_2 + 1);
  ...
  harmonyInstrumentSelector_.addItem("Synth Strings 1",
                                     GM::SYNTH_STRINGS_1 + 1);
  harmonyInstrumentSelector_.setSelectedId(GM::STRING_ENSEMBLE_1 + 1);
  harmonyInstrumentSelector_.setTooltip(
      "Harmony instrument: Provides chordal accompaniment");
  ...
  harmonyTechniqueLabel_.setText("Harmony Technique",
                                 juce::dontSendNotification);
  harmonyTechniqueLabel_.setFont(
      juce::FontOptions(13.0f).withStyle("Medium")); // Larger, readable
  harmonyTechniqueLabel_.setColour(
      juce::Label::textColourId,
      KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(harmonyTechniqueLabel_);

  harmonyTechniqueSelector_.setTooltip(
      "Playing technique for harmony instrument");
  ...
  bassInstrumentLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  bassInstrumentLabel_.setColour(
      juce::Label::textColourId,
      KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(bassInstrumentLabel_);

  bassInstrumentSelector_.addItem("Acoustic Bass", GM::ACOUSTIC_BASS + 1);
  bassInstrumentSelector_.addItem("Electric Bass (Finger)",
                                  GM::ELECTRIC_BASS_FINGER + 1);
  bassInstrumentSelector_.addItem("Electric Bass (Pick)",
                                  GM::ELECTRIC_BASS_PICK + 1);
  ...
  bassInstrumentSelector_.setTooltip(
      "Bass instrument: Provides the low-frequency foundation");
  ...
  bassTechniqueLabel_.setFont(
      juce::FontOptions(13.0f).withStyle("Medium")); // Larger, readable
  bassTechniqueLabel_.setColour(juce::Label::textColourId,
                                KellyLookAndFeel::textPrimary); // Brighter text
  ...
  // Texture Instruments
  textureInstrumentLabel_.setText("Texture Instrument",
                                  juce::dontSendNotification);
  textureInstrumentLabel_.setFont(
      juce::FontOptions(14.0f).withStyle("SemiBold")); // Larger, bolder
  textureInstrumentLabel_.setColour(
      juce::Label::textColourId,
      KellyLookAndFeel::textPrimary); // Brighter text
  ...
  textureInstrumentSelector_.setTooltip(
      "Texture instrument: Adds atmospheric pads and background layers");
  ...
  textureTechniqueLabel_.setText("Texture Technique",
                                 juce::dontSendNotification);
  textureTechniqueLabel_.setFont(
      juce::FontOptions(13.0f).withStyle("Medium")); // Larger, readable
  textureTechniqueLabel_.setColour(
      juce::Label::textColourId,
      KellyLookAndFeel::textPrimary); // Brighter text
  addAndMakeVisible(textureTechniqueLabel_);

  textureTechniqueSelector_.setTooltip(
      "Playing technique for texture instrument");
...
void MusicTheoryPanel::initializeTechniques() {
  ...
  } else if (leadInst >= GM::ACOUSTIC_GUITAR_NYLON &&
             leadInst <= GM::GUITAR_HARMONICS) {
    // Guitar techniques
  ...
  if (harmonyInst >= GM::STRING_ENSEMBLE_1 &&
      harmonyInst <= GM::SYNTH_STRINGS_2) {
...
void MusicTheoryPanel::paint(juce::Graphics &g) {
  ...
  juce::ColourGradient gradient(
      ...
      KellyLookAndFeel::backgroundLight, bounds.getBottomLeft(), false);
  ...
  juce::ColourGradient headerGradient(
      juce::Colour(0xFF3B82F6).withAlpha(0.15f),
      headerBounds.getTopLeft(), // Focus Blue #3B82F6
      juce::Colour(0xFFA855F7).withAlpha(0.1f),
      headerBounds.getBottomLeft(), // Creative Purple #A855F7
      false);
  ...
  g.drawText("MUSIC THEORY", headerBounds.translated(1.0f, 1.0f),
  ...
  auto accentLine = juce::Rectangle<float>(
      0.0f, headerBounds.getBottom() - 2.0f, headerBounds.getWidth(), 2.0f);
...
void MusicTheoryPanel::resized() {
  ...
  keyLabel_.setBounds(
      theoryRow.removeFromLeft(third).removeFromTop(20)); // Larger label
  keySelector_.setBounds(
      theoryRow.removeFromLeft(third).removeFromTop(28).translated(
          0, 22)); // Larger selector

  scaleLabel_.setBounds(theoryRow.removeFromLeft(third).removeFromTop(20));
  scaleSelector_.setBounds(
      theoryRow.removeFromLeft(third).removeFromTop(28).translated(0, 22));
  ...
  auto timeRow =
      bounds.removeFromTop(60); // More height for tempo slider with value box
  auto half = timeRow.getWidth() / 2;

  timeSigLabel_.setBounds(timeRow.removeFromLeft(half).removeFromTop(20));
  auto timeSigArea =
      timeRow.removeFromLeft(half).removeFromTop(28).translated(0, 22);
  timeSigNumSelector_.setBounds(timeSigArea.removeFromLeft(70)); // Larger
  timeSigDenSelector_.setBounds(
      timeSigArea.removeFromLeft(70).translated(10, 0)); // Larger

  tempoLabel_.setBounds(timeRow.removeFromTop(20));
  tempoSlider_.setBounds(
      timeRow.removeFromTop(50)); // More height for value box above
  ...
  leadInstrumentSelector_.setBounds(leadControls.removeFromLeft(
      static_cast<int>(leadControls.getWidth() * 0.6f)));
  leadTechniqueLabel_.setBounds(
      leadControls.removeFromTop(18).translated(8, 0)); // Larger, more spacing
  ...
  harmonyInstrumentSelector_.setBounds(harmonyControls.removeFromLeft(
      static_cast<int>(harmonyControls.getWidth() * 0.6f)));
  harmonyTechniqueLabel_.setBounds(
      harmonyControls.removeFromTop(18).translated(8, 0));
  ...
  bassInstrumentSelector_.setBounds(bassControls.removeFromLeft(
      static_cast<int>(bassControls.getWidth() * 0.6f)));
  bassTechniqueLabel_.setBounds(
      bassControls.removeFromTop(18).translated(8, 0));
  ...
  textureInstrumentSelector_.setBounds(textureControls.removeFromLeft(
      static_cast<int>(textureControls.getWidth() * 0.6f)));
  textureTechniqueLabel_.setBounds(
      textureControls.removeFromTop(18).translated(8, 0));
  ...
  reverbToggle_.setBounds(
      reverbArea.removeFromLeft(90).removeFromTop(22)); // Larger toggle
  reverbSlider_.setBounds(
      reverbArea.removeFromTop(50)); // More height for value box above
  ...
  eqAutoApplyLabel_.setBounds(
      eqControls.removeFromLeft(80).removeFromTop(20).translated(10, 0));
  eqAutoApplyToggle_.setBounds(
      eqControls.removeFromLeft(24).removeFromTop(22).translated(10, 0));
...
MusicTheoryPanel::TheorySettings MusicTheoryPanel::getSettings() const {
  ...
  settings.timeSigDenominator =
      timeSigDenSelector_.getSelectedId() == 1
          ? 2
          : (timeSigDenSelector_.getSelectedId() == 2
                 ? 4
...
void MusicTheoryPanel::setCustomProgression(const juce::String &progression,
                                            bool strict) {
...
std::vector<int> MusicTheoryPanel::parseProgressionString(
    const juce::String &progression) const {
...
void MusicTheoryPanel::setTempo(int tempo) {
  tempoSlider_.setValue(juce::jlimit(40.0, 200.0, static_cast<double>(tempo)),
                        juce::dontSendNotification);
  // Note: don't call notifySettingsChanged() - this is programmatic update
}

void MusicTheoryPanel::setProgression(
    const std::vector<juce::String> &progression) {
