 ...
 *
 * Based on UX research: Tooltips reduce cognitive load and improve
 * discoverability
 */
...
public:
  ...
  static void showTooltip(juce::Component *target, const juce::String &text,
                          int timeoutMs = 3000);
...
class TooltipHelper {
public:
  static void setTooltip(juce::Component *component,
