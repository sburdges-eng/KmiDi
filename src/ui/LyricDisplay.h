...
/**
 * LyricDisplay - Displays lyric lines with syllable breakdown and playback
 * synchronization.
 *
 * Features:
 * - Display lyric lines
 ...
 */
class LyricDisplay : public juce::Component, public juce::Timer {
public:
  LyricDisplay();
   ...
   */
  void setHighlightSyllables(bool highlight) {
    highlightSyllables_ = highlight;
  }
