...
class TestEmbeddingRegularizer:
    ...
    def test_l2_regularization_loss(self):
        ...
        config = RegularizationConfig(regularization_type=RegularizationType.L2, l2_lambda=0.001)
    ...
    def test_l1_regularization_loss(self):
        ...
        config = RegularizationConfig(regularization_type=RegularizationType.L1, l1_lambda=0.001)
        regularizer = EmbeddingRegularizer(config)
    ...
    def test_gradient_clipping(self):
        ...
        config = RegularizationConfig(clip_gradients=True, max_gradient_norm=1.0)
        regularizer = EmbeddingRegularizer(config)
...
class TestCreateRegularizedMapper:
    ...
    def test_create_custom_strength(self):
        ...
        config, regularizer = create_regularized_mapper(regularization_strength=0.005)

        assert config.regularization.l2_lambda == 0.005

    def test_create_with_dropout(self):
        """Test creating with dropout enabled."""
        config, regularizer = create_regularized_mapper(use_dropout=True)
    ...
    def test_create_fast_inference(self):
        ...
        config, regularizer = create_regularized_mapper(use_fast_inference=True)
