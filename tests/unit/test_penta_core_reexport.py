...
class TestSingleSourceOfTruth:
    ...
    def test_impl_alias_in_sys_modules(self):
        ...
        assert "_penta_core_impl" in sys.modules, (
    ...
    def test_impl_is_canonical_source(self):
        ...
        assert os.path.abspath(impl.__file__) == os.path.abspath(expected), (
    ...
    def test_harmony_module_identity_vs_impl(self):
        ...
        assert sys.modules["penta_core.harmony"] is impl_harmony, (
    ...
    def test_music_brain_on_sys_path(self):
        ...
        assert music_brain in sys.path, (
