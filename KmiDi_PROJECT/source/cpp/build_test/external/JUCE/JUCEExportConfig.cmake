...
if(NOT TARGET juce::juceaide)
    ...
    set_target_properties(juce::juceaide PROPERTIES
        IMPORTED_LOCATION "/opt/homebrew/bin/cmake")
endif()

check_required_components("JUCE")

set(JUCE_MODULES_DIR "/Users/seanburdges/KmiDi-1/external/JUCE/modules" CACHE INTERNAL
    "The path to JUCE modules")

include("/Users/seanburdges/KmiDi-1/external/JUCE/extras/Build/CMake/JUCEModuleSupport.cmake")
include("/Users/seanburdges/KmiDi-1/external/JUCE/extras/Build/CMake/JUCEUtils.cmake")
...
foreach(_juce_module IN LISTS _juce_modules)
    juce_add_module("/Users/seanburdges/KmiDi-1/external/JUCE/modules/${_juce_module}" ALIAS_NAMESPACE juce)
endforeach()
