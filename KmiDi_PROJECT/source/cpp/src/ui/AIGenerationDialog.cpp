...
AIGenerationDialog::AIGenerationDialog() {
    ...
    numTracksLabel_.setFont(juce::Font(12.0f));
    ...
    useSideALabel_.setFont(juce::Font(12.0f));
    ...
    useSideBLabel_.setFont(juce::Font(12.0f));
    ...
    blendSidesLabel_.setFont(juce::Font(12.0f));
    ...
    variabilityLabel_.setFont(juce::Font(12.0f));
    ...
    barsPerTrackLabel_.setFont(juce::Font(12.0f));
    ...
    apiKeyLabel_.setFont(juce::Font(12.0f));
    ...
    apiKeyEditor_.setFont(juce::Font(11.0f));
    ...
    saveApiKeyLabel_.setFont(juce::Font(11.0f));
