...
MusicTheoryPanel::MusicTheoryPanel() {
    ...
    keyLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    scaleLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    modeLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    timeSigLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    tempoLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    reverbLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    delayLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    chorusLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    notationStyleLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    eqLabel_.setFont(juce::Font(14.0f, juce::Font::bold));
    ...
    eqPresetLabel_.setFont(juce::Font(14.0f, juce::Font::bold));
    ...
    eqAutoApplyLabel_.setFont(juce::Font(12.0f));
...
void MusicTheoryPanel::initializeInstruments() {
    ...
    leadInstrumentLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    leadTechniqueLabel_.setFont(juce::Font(13.0f));  // Larger, readable
    ...
    harmonyInstrumentLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    harmonyTechniqueLabel_.setFont(juce::Font(13.0f));  // Larger, readable
    ...
    bassInstrumentLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    bassTechniqueLabel_.setFont(juce::Font(13.0f));  // Larger, readable
    ...
    textureInstrumentLabel_.setFont(juce::Font(14.0f, juce::Font::bold));  // Larger, bolder
    ...
    textureTechniqueLabel_.setFont(juce::Font(13.0f));  // Larger, readable
