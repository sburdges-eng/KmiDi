...
void SuggestionOverlay::rebuildCards() {
    ...
    for (const auto& suggestion : suggestions_) {
        ...
        juce::Font titleFont = juce::Font(16.0f);
        ...
        juce::Font descFont = juce::Font(13.0f);
        card->descriptionLabel->setFont(descFont);
        ...
        juce::Font confFont = juce::Font(11.0f);
        card->confidenceLabel->setFont(confFont);
        ...
        juce::Font expFont = juce::Font(12.0f);
        card->explanationLabel->setFont(expFont);
