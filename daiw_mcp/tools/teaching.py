            ...
            if name == "explain_rulebreak":
                ...
                emotion_mapping = {
                    ...
                    "anger": {
                        "key": "minor",
                        "tempo": "fast",
                        "rule_breaks": ["HARMONY_UnresolvedDissonance"],
                    },
                    "nostalgia": {
                        "key": "major",
                        "tempo": "moderate",
                    ...
                    "defiance": {
                        "key": "minor",
                        "tempo": "fast",
                        "rule_breaks": ["HARMONY_ParallelMotion"],
                    },
                }

                base_mapping = emotion_mapping.get(
                    emotion.lower(), {"key": "major", "tempo": "moderate", "rule_breaks": []}
                )
