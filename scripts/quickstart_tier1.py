...
from music_brain.tier1 import Tier1AudioGenerator, Tier1MIDIGenerator, Tier1VoiceGenerator
...
def main():
    ...
    audio = audio_gen.synthesize_texture(
        midi_result["melody"], midi_result["groove"], emotion_embedding, duration_seconds=4.0
    )
