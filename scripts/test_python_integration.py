...
def test_intent_processing():
    ...
    try:
        ...
        print(
            f"  ✅ Created intent: {intent.song_intent.mood_primary} in {intent.technical_constraints.technical_key}"  # noqa: E501
        )
    ...
    try:
        ...
        if emotions_dir.exists():
            ...
            if joy_file.exists():
                ...
                print(
                    f"  ✅ Loaded joy.json: {len(joy_data.get('intensity_tiers', []))} intensity tiers"  # noqa: E501
                )
        else:
