    ...
    try:
        while True:
            ...
            if verbose and n % 100 == 0:
                print(
                    f"  t={t:.2f} valence={valence:.3f} arousal={arousal:.3f} dynamics={dynamics:.3f}"  # noqa: E501
                )
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Stream synthetic affect curves as UMP 32-bit CC to a MIDI port (see midi/README.md)."  # noqa: E501
    )
    ap.add_argument(
        "--port",
        type=str,
