...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("penta_server.log"), logging.StreamHandler(sys.stdout)],
)
...
class EnhancedRequestHandler(SimpleHTTPRequestHandler):
    ...
    def _handle_status(self):
        ...
        status = {"server": "running", "config": CONFIG, "music_engine": music_engine is not None}
        if music_engine:
    ...
    def _handle_harmony(self):
        ...
        self._send_json({"chord": chord, "scale": scale})
    ...
    def _handle_midi_analysis(self):
        ...
        try:
            ...
            self._send_json({"success": True, "chord": music_engine.harmony.get_current_chord()})
        except Exception as e:
    ...
    def _handle_audio_analysis(self):
        ...
        try:
            ...
            self._send_json({"success": True, "analysis": music_engine.groove.get_analysis()})
        except Exception as e:
            self._send_error(400, f"Invalid request: {e}")
    ...
    def _handle_chord_analysis(self):
        ...
        try:
            ...
            self._send_json({"success": True, "progression": progression})
        except Exception as e:
            self._send_error(400, f"Invalid request: {e}")
    ...
    def _analyze_progression(self, chords: List[str]) -> dict:
        ...
        return {
            ...
            "length": len(chords),
            "pattern": "Custom"
            if tuple(chords) not in common_progressions
            else common_progressions[tuple(chords)],
        }
