...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=2048,
        help="Max context length for static shapes (default 2048). Required for Core ML stateful backend.",  # noqa: E501
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    # Static context length required for Core ML stateful backend (ExecuTorch may accept one or both)  # noqa: E501
