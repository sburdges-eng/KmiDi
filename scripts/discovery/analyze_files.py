...
def main():
    ...
    if 'code_files' in data:
        ...
        for file_info in code_data.get('files', []):
            ...
            if opportunities['can_integrate']:
                results['summary']['integration_opportunities'][opportunities['integration_priority']] += 1
    ...
    if 'documentation' in data:
        ...
        for file_info in doc_data.get('files', []):
            ...
            opportunities = identify_integration_opportunities(file_info, assessment, 'documentation')
    ...
    results['summary']['integration_opportunities'] = dict(results['summary']['integration_opportunities'])
    ...
    with open(md_path, 'w') as f:
        ...
        high_value_code = [r for r in results['code_files'] 
        ...
        for result in high_value_code[:50]:
            ...
            f.write(f"  - Value: {result['assessment']['value_level']} (Score: {result['assessment']['value_score']})\n")
        ...
        high_value_docs = [r for r in results['documentation_files'] 
                          if r['assessment']['value_level'] in ['Critical', 'High']
                          and r['opportunities']['can_integrate']]
        ...
        high_value_models = [r for r in results['model_files'] 
                            if r['assessment']['value_level'] in ['Critical', 'High']
                            and r['opportunities']['can_integrate']]
