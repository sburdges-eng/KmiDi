...
class HarmonyGenerator:
    ...
    def generate_basic_progression(
        ...
        return HarmonyResult(chords=chord_symbols, voicings=voicings, key=key, mode=mode)
    ...
    def _roman_to_chord_symbols(self, roman_numerals: List[str], key: str, mode: str) -> List[str]:
        """
    ...
    def _chords_to_voicings(self, chord_symbols: List[str], key: str) -> List[ChordVoicing]:
        """
...
if __name__ == "__main__":
    ...
    basic_harmony = generator.generate_basic_progression(key="C", mode="major", pattern="I-V-vi-IV")
