...
def test_emotion_to_intent():
    ...
    intent = CompleteSongIntent(
        ...
        technical_constraints=TechnicalConstraints(technical_key="C", technical_tempo_range=(120, 140))
    )
...
def test_complete_workflow():
    ...
    intent = CompleteSongIntent(
        song_root=SongRoot(
            core_event="Creating a joyful song",
            core_longing="To express happiness"
        ),
        song_intent=SongIntent(mood_primary="joyful"),
...
if __name__ == "__main__":
    ...
    results = [
        test_emotion_to_intent(),
        test_intent_to_engines(),
