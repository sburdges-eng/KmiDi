...
public:
  ...
  juce::String getEmotionInputText() const { return emotionInput_.getText(); }
  void setEmotionInputText(const juce::String &text) {
    emotionInput_.setText(text);
  }
  void setPreviewText(const juce::String &text) { previewText_.setText(text); }
  bool isAutoGenerateEnabled() const { return autoGenerateButton_.getToggleState(); }
  void applyEmotionSelection(const EmotionNode &emotion);
  ...
  std::function<void(const juce::String &text)> onEmotionTextCommitted;
  std::function<void(const juce::String &text)> onWoundTextChanged;
  std::function<void(bool enabled)> onAutoGenerateToggled;
...
private:
  ...
  juce::TextEditor emotionInput_;
  juce::Label emotionLabel_{"", "Emotion"};
  juce::TextEditor previewText_;
  juce::Label previewLabel_{"", "Preview"};
  ...
  juce::ComboBox techniqueSelector_;
  juce::Label techniqueLabel_{"", "Technique"};
  juce::ComboBox songSectionSelector_;
  juce::Label songSectionLabel_{"", "Song Section"};
  juce::Slider songAmountSlider_;
  juce::Label songAmountLabel_{"", "Song Amount"};
  juce::ToggleButton useHostTempoButton_{"Use Host Tempo"};
  juce::ToggleButton autoGenerateButton_{"Auto-Generate (Idle)"};
