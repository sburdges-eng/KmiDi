...
Downloads audio to the configured dataset root (see penta_core.ml.datasets.get_audio_data_root).
...
class AudioDownloader:
    ...
    All downloads go to the configured downloads directory.
    """
    ...
    def download_freesound_pack(
        ...
        try:
            ...
            response = requests.get(pack_url, headers=headers, timeout=REQUEST_TIMEOUT_SECONDS)
            response.raise_for_status()
