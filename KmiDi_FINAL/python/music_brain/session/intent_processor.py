...
def _get_note_index(note: str) -> int:
    ...
    if normalized and normalized in CHROMATIC:
...
class IntentProcessor:
    ...
    def __init__(self, intent: Optional[CompleteSongIntent] = None):
        self.intent: Optional[CompleteSongIntent] = None
        if intent is not None:
            self.set_intent(intent)

    def set_intent(self, intent: CompleteSongIntent) -> None:
        """Assign intent and parse cached fields."""
        self.intent = intent
        self._parse_intent()
    ...
    def generate_all(self) -> Dict:
        ...
        if self.intent is None:
            raise ValueError("IntentProcessor has no intent; call set_intent() first.")
        return {
    ...
    def process_intent(self, intent: CompleteSongIntent) -> Dict:
        """Process an intent and return all generated elements."""
        self.set_intent(intent)
