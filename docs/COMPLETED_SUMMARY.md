...
- **`scripts/dev-setup.sh`:** Runs (1) `bootstrap.sh`, (2) `npm install`, (3) `pip install -e .` (and optional uvicorn/pydantic extras). After this, developers use `npm run dev:all` (or individual dev commands).
