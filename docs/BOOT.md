...
2. mcp_workstation          – multi-AI orchestration (optional, scripts/mcp/)
...
- Located at `scripts/mcp/mcp_workstation/`.
- Multi-AI orchestration workspace (Claude, ChatGPT, Gemini, GitHub Copilot).
- Start with: `python -m mcp_workstation status` (from `scripts/mcp/`).
