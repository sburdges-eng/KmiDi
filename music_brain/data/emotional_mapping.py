...
def _apply_modifier(params: MusicalParameters, modifier: EmotionModifier) -> MusicalParameters:
    ...
    new_params.dissonance = min(1.0, max(0.0, new_params.dissonance + modifier.dissonance_adjust))
