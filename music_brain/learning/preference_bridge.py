...
Usage:
    python preference_bridge.py record_parameter_adjustment \\
        '{"parameter_name": "valence", "old_value": 0.5, "new_value": 0.7}'
"""
...
def record_midi_feedback(model, args):
    ...
    model.record_midi_feedback(generation_id=args["generation_id"], accepted=args["accepted"])
...
def record_rule_break_modification(model, args):
    ...
    model.record_rule_break_modification(
        rule_break=args["rule_break"], action=args["action"], context=args.get("context", {})
    )
