...
class ComprehensiveIntegrationManager:
    ...
    def send_to_daw(self, daw_name: str, midi_data: Any) -> bool:
        ...
        if bridge is None:
            try:
                # importlib honors sys.modules overrides (tests inject a fake
                # daw_bridges); plain `import a.b.c` binds through the real
                # parent package's attributes instead.
                _bridges = importlib.import_module("music_brain.agents.daw_bridges")
