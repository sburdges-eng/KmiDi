...
from music_brain.kelly_companion.groove.extractor import GrooveTemplate
...
GENRE_TEMPLATES = {
    "funk": {
        ...
        "timing_deviations": [
            ...
            -8,
            5,
            -5,  # Beat 1: slight push on 16th notes
            12,
            -6,
            8,
            -4,  # Beat 2: laid back snare
            0,
            -10,
            6,
            -6,  # Beat 3
        ...
        "velocity_curve": [
            ...
            60,
            85,
            55,  # Beat 1: strong downbeat
            95,
            55,
            75,
            50,  # Beat 2: snare accent
            85,
            50,
            70,
            45,  # Beat 3
...
def get_genre_template(genre: str) -> GrooveTemplate:
    ...
    return GrooveTemplate(
        ...
        timing_stats={
            "mean_deviation_ms": sum(abs(d) for d in data["timing_deviations"])
            / len(data["timing_deviations"])
            * 0.5,  # noqa: E501
