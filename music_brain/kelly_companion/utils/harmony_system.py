...
from .harmony_deps.chord_detector import ChordDetector, PolyphonicScorer, JazzChordAnalyzer
from .harmony_deps.key_analyzer import KeyScaleAnalyzer, KeyAnalyzer, KeyEstimate, Mode
from .harmony_deps.harmony_engine import (
    ProbabilisticHarmonyEngine,
    Genre,
    VoiceLeadingAnalyzer,
    TensionResolutionAnalyzer,
)
from .harmony_deps.chord_memory import ChordMemorySystem, SectionType
...
class IntelligentHarmonySystem:
    ...
    def analyze_notes(self, notes: List[str], duration: float = 1.0) -> HarmonyAnalysis:
        ...
        if self.last_voicing:
            _vl_score = self.voice_leading.voice_leading_score(  # noqa: F841
