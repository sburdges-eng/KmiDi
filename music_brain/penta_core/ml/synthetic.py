...
class SyntheticGenerator:
    ...
    def _generate_notes_from_progression(
        ...
        for bar in range(bars):
            ...
            chord_type = 'min' if 'i' in chord_symbol.lower(
            ...
            for sample in self.samples:
                ...
                if self.model_name == "emotion_recognizer":
                    ...
                    if notes:
                        ...
                        pitches = [int(n.get("pitch", 60)) %
                                   self.input_dim for n in notes[:seq_len]]
                        # Pad if needed
                ...
                if self.model_name == "emotion_recognizer":
                    ...
                    groove_map = {"straight": 0, "swing": 1,
                                  "shuffle": 2, "laid_back": 3, "rushed": 4}
