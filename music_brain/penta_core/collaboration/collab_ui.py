        ...
        with tab2:
            ...
            with col1:
                ...
                mood_primary = st.selectbox(
                    ...
                    options=moods,
                    index=(
                        moods.index(emotional.get("moodPrimary", "Joy"))
            ...
            with col2:
                ...
                narrative_arc = st.selectbox(
                    ...
                    options=arcs,
                    index=(
                        arcs.index(emotional.get("narrativeArc", "Standard").title())
        ...
        with tab3:
            ...
            with col1:
                ...
                genre = st.selectbox(
                    ...
                    options=genres,
                    index=(
                        genres.index(technical.get("genre", "Pop"))
            ...
            with col2:
                ...
                key_selection = st.selectbox(
                    ...
                    options=key_modes,
                    index=(
                        key_modes.index(technical.get("key", "C Major"))
            ...
            with col1:
                ...
                time_sig = st.selectbox(
                    ...
                    index=(
                        time_signatures.index(technical.get("timeSignature", "4/4"))
