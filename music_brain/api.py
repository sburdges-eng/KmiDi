...
if FASTAPI_AVAILABLE:
    ...
    # Sandbox for /audio/ serving: only files under this directory are allowed (prevents path traversal).  # noqa: E501
    ...
    def _resolve_audio_path_sandbox(audio_path: str) -> Path:
        """Resolve audio_path and ensure it is under _audio_serve_root. Raises HTTPException 400 if outside."""  # noqa: E501
    ...
    async def serve_audio(file_path: str):
        """Stream generated audio files for playback. Paths are restricted to KMIDI_AUDIO_SERVE_ROOT (default: temp)."""  # noqa: E501
        import urllib.parse
