...
class DAiWAPI:
    ...
    def therapy_session(
        ...
        result = {
            "affect": {
                "primary": affect,
                "secondary": session.state.affect_result.secondary if session.state.affect_result else None,  # noqa: E501

                "intensity": session.state.affect_result.intensity if session.state.affect_result else 0.0,  # noqa: E501
