    ...
    def _get(self):
        if self._instance is None:
            try:
                ...
                raise ImportError("music_brain.api.DAiWAPI not available")
...
def file_to_base64(path: str) -> str:
    ...
    Security: reads whatever path it is given. Callers that accept paths from
    an untrusted source (e.g. MCP tool arguments) must validate/allowlist the
    path before calling this helper.
    """
