...
Examples:
  ...
  %(prog)s animate song.mid -o hq.gif --particles 3000 --fps 20
    ...
    render_parser.add_argument(
        "-o",
        "--output",
        default="spectocloud.png",
        help="Output image path (default: spectocloud.png)",
    )
    render_parser.add_argument(
        "-f", "--frame", default="all", help='Frame index or "all" (default: all)'
    )
    render_parser.add_argument("-e", "--emotion", default=None, help="Emotion trajectory JSON file")
    render_parser.add_argument(
        "-a",
        "--anchors",
        default="normal",
    ...
    render_parser.add_argument(
        "-p", "--particles", type=int, default=1500, help="Number of particles (default: 1500)"
    )
    render_parser.add_argument(
        "-w", "--window", type=float, default=0.2, help="Time window size in seconds (default: 0.2)"
    )
    ...
    animate_parser.add_argument(
        "-o",
        "--output",
        default="spectocloud.gif",
        help="Output GIF path (default: spectocloud.gif)",
    )
    animate_parser.add_argument(
        "-e", "--emotion", default=None, help="Emotion trajectory JSON file"
    )
    animate_parser.add_argument(
    ...
    animate_parser.add_argument(
        "--rotate", action="store_true", default=True, help="Rotate camera (default: True)"
    )
    animate_parser.add_argument(
        "--no-rotate", dest="rotate", action="store_false", help="Disable camera rotation"
    )
    animate_parser.add_argument(
        "-a",
        "--anchors",
    ...
    animate_parser.add_argument(
        "-p", "--particles", type=int, default=1200, help="Number of particles (default: 1200)"
    )
    animate_parser.add_argument(
        "-w", "--window", type=float, default=0.2, help="Time window size in seconds (default: 0.2)"
    )
