...
Stage 3: Expand — request + validated → CompleteSongIntent
(full internal fields; imagery_texture only here).
...
class IntentPipeline:
    ...
    def normalize(self, request: Any) -> Dict[str, Any]:
        ...
        - Applies emotion_map to emotional_intent to infer mood_primary
