...
class RuleBreakCode(Enum):
    ...
    RHYTHM_MeterAmbiguity = "RHYTHM_MetricModulation"
    RHYTHM_ConstantDisplacement = "RHYTHM_ConstantDisplacement"
    RHYTHM_TempoFluctuation = "RHYTHM_TempoFluctuation"
    STRUCTURE_NonResolution = "HARMONY_AvoidTonicResolution"
    PRODUCTION_BuriedVocals = "ARRANGEMENT_BuriedVocals"
